...
public class AddRoom extends JFrame implements ActionListener{
    ...
    private JComboBox comboBox, comboBox_1, comboBox_2, comboBox_3,comboBox_30;
    JButton b1,b2;
    Choice c1;
	...
	contentPane.add(comboBox_2);
        ...
        JLabel l56 = new JLabel("Ac");
	l56.setForeground(new Color(25, 25, 112));
	l56.setFont(new Font("Tahoma", Font.BOLD, 14));
	l56.setBounds(64, 270, 102, 22);
	contentPane.add(l56);

        comboBox_30 = new JComboBox(new String[] { "AC", "Non-AC" });
	comboBox_30.setBounds(176, 270, 154, 20);
    ...
    public void actionPerformed(ActionEvent ae){
        try{
            ...
            if(ae.getSource() == b1){
                ...
                String ac = (String)comboBox_30.getSelectedItem();

                String str = "INSERT INTO room values( '"+room+"', '"+available+"', '"+status+"','"+price+"', '"+type+"' ,'"+ac+"')";
