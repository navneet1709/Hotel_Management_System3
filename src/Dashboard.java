...
public class Dashboard extends JFrame{
	...
	menuBar.add(AirlineSystemHello);
        ...
        JMenu AirlineSystemHello2 = new JMenu("Contact Us");
        AirlineSystemHello2.setForeground(Color.BLACK);
	menuBar.add(AirlineSystemHello2);

        JMenu  AirlineSystemHello3 = new JMenu("About");
        AirlineSystemHello3.setForeground(Color.BLACK);
	menuBar.add(AirlineSystemHello3);

        // AirlineSystemHello3.addActionListener(new ActionListener(){
